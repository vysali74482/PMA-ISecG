...
app.controller('UserController', ['$scope', '$http', '$filter', '$location',
function UserController($scope, $http, $filter, $location) {
...
app.controller('UserIndexController', ['$scope', '$http', '$filter', '$location',
  function UserIndexController($scope, $http, $filter, $location) {
      ...
      $scope.OpenClose = function (req) {
          //alert('hit');
          var x;
          var r = confirm("Are you sure you want to close this user?");
          if (r == true) {
      ...
      $scope.Delete = function (user) {
          ...
          if (r == true) {
              ...
              $http({
                  ...
                  $scope.isBusy = false;
                  alert("User successfully deleted. However, you can still reactivate it.");
                  user.isActive = false;
                  $location.path('/users');
                  //$scope.reqToAddData = {};
...
app.controller('UserAddController', ['$scope', '$http', '$filter', '$location', '$routeParams',
  function UserAddController($scope, $http, $filter, $location, $routeParams) {
      ...
      $scope.users = [
   { "UserId": 9, "UserName": "Andy" },
   { "UserId": 10, "UserName": "Neha" }
